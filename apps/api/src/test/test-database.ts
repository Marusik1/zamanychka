  ...
  return {
    ...
    clean: () =>
      prisma.$executeRawUnsafe(
        'TRUNCATE TABLE "MatchParticipantResult", "MatchResult", "OutboxRow", "ProcessedAction", "MatchEvent", "RoomInvite", "RoomSeat", "RoomMembership", "Match", "Room", "AuthSession", "User" CASCADE',
      ),
  };
}
